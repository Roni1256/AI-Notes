  ...
  return (
    <div className="min-h-screen bg-white flex items-center justify-center px-4">
      <div className="max-w-md w-full bg-gray-50 rounded-lg shadow-lg p-8">
        ...
        <h2 className="text-2xl font-bold text-center text-black mb-8">Verification Code</h2>
        <p className="text-gray-600 text-center mb-6">Please enter the verification code sent to your email</p>
        ...
        <p className="text-gray-600 text-center mt-6">
          Didn't receive code? <button onClick={handleResend} className="text-black font-semibold hover:underline flex items-center justify-center inline-flex"><FaRedoAlt className="mr-1" />Resend</button>
        </p>
      </div>
    </div>
  )
